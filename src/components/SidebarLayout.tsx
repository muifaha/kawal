...
export default function SidebarLayout({ children, user }: SidebarLayoutProps) {
  ...
  const navigation: NavigationItem[] = [
    ...
    },
    {
      ...
      href: "/absensi",
      icon: CalendarCheck,
      roles: ["BK", "WAKA", "WALAS", "GURU", "SEKRETARIS", "PIKET"],
    },
    {
      name: "Rekap Absensi",
      href: "/rekap-absensi",
        ...
        <div className="flex-1 flex flex-col min-h-0">
          ...
          <div className="p-4 border-t border-slate-800 space-y-1">
            <button
              ...
              className="w-full flex items-center px-4 py-3 text-sm font-medium text-emerald-400 hover:bg-emerald-500/10 rounded-xl transition-all duration-200 border border-emerald-500/20 hover:border-emerald-500/40 cursor-pointer"
            >
              <Smartphone className="mr-3 h-5 w-5 shrink-0 text-emerald-400" />
          ...
          <div className="fixed inset-y-0 left-0 max-w-xs w-full bg-slate-900 p-6 flex flex-col border-r border-slate-800">
            ...
            <div className="pt-4 border-t border-slate-800 space-y-1">
              <button
                ...
                className="w-full flex items-center px-4 py-3 text-sm font-medium text-emerald-400 hover:bg-emerald-500/10 rounded-xl transition-all border border-emerald-500/20 hover:border-emerald-500/40 cursor-pointer"
              >
                <Smartphone className="mr-3 h-5 w-5 shrink-0 text-emerald-400" />
                <span>Install Aplikasi</span>
              </button>
